...
if os.environ.get('DJANGO_DB_ENGINE') == 'postgresql':
    DATABASES = {
        'default': {
            ...
            'NAME': os.environ.get('POSTGRES_DB', 'productivity_software'),
...
# To use Gmail SMTP once you have valid credentials, uncomment the lines below:
# EMAIL_BACKEND = 'django.core.mail.backends.smtp.EmailBackend'
# EMAIL_HOST = 'smtp.gmail.com'
# EMAIL_PORT = 587
# EMAIL_USE_TLS = True
# EMAIL_HOST_USER = 'your.email@gmail.com'
# EMAIL_HOST_PASSWORD = 'your-app-password'  # Use App Password if 2-Step Verification is enabled
